...
# ── module subcommand ──────────────────────────────────────────
# Implementation lives in fit_check_module.py; re-exported here so existing
# imports (e.g. `from mkts_backend.cli_tools.fit_check import module_command`)
# keep working.
from mkts_backend.cli_tools.fit_check_module import (  # noqa: E402
    _resolve_module_identity,
    _query_module_usage,
    module_command,
)
...
# ── needed subcommand ──────────────────────────────────────────
# Implementation lives in fit_check_needed.py; re-exported for backward
# compatibility with existing imports.
from mkts_backend.cli_tools.fit_check_needed import (  # noqa: E402, F401
    _query_needed_data,
    _resolve_ship_filters,
    needed_command,
)
from mkts_backend.cli_tools.fit_check_needed import handle_needed as _handle_needed  # noqa: E402, F401
...
from mkts_backend.cli_tools.fit_check_module import handle_module as _handle_module  # noqa: E402, F401
